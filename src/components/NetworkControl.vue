<template>
  <button @click="toggleCurrentNetwork"
    ...
    <div class="absolute inset-0 rounded-xl bg-gradient-to-br from-blue-500/20 to-cyan-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
    ...
    <img :src="networkIconSrc" :alt="networkAlt" 
